...
Download `zoo_ev833zj0mxpwq_v50242.msi` from release `v96207` and run the installer.
...
- Module updates are delivered through new GitHub release tags; pin `v96207` for pilot groups.
